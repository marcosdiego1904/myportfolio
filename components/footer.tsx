        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            <Link href="#" className="flex items-center gap-3 group">
              <span className="text-2xl font-bold">Marcos Barzola</span>
            </Link>
          ...
          <div className="flex flex-col items-center md:items-start gap-4">
            ...
            <Link
              href="mailto:marcosbarzola@devbymarcos.com"
              className="flex items-center gap-2 text-[var(--text-secondary)] hover:text-[var(--accent-primary)] transition-colors group"
            >
              <Mail className="h-4 w-4" />
              <span className="group-hover:underline">marcosbarzola@devbymarcos.com</span>
            </Link>
            <div className="flex items-center gap-3 mt-2">
              <Link
                href="https://www.linkedin.com/in/marcosbarzoladev"
                target="_blank"
        ...
        <div className="border-t border-[var(--border-dark)] pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-[var(--text-secondary)] text-center md:text-left">
              © 2025 Marcos Barzola. All rights reserved.
            </p>
